...
export const AdvertismentHeaderComponent = ({header, localization, user,  img_src, settingsClick}) => {
  return (
    <div className="headerComponent2">
      ...
      <div>{user ? <FontAwesomeIcon onClick={() => settingsClick()} className='headerComponent2__btn' icon="cog"/> : <FontAwesomeIcon className='btn' icon="heart"/> }
      </div>
      </div>
